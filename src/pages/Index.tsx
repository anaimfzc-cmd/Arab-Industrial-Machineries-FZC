...
import heroVideo from "@/assets/hero-indus-vid.mp4";

import installationImg from "@/assets/service-installation.png";
import maintenanceImg from "@/assets/service-maintenance.png";
import fabricationImg from "@/assets/service-fabrication.jpg";
import commissioningImg from "@/assets/service-commissioning.png";
...
const services = [
  {
    ...
    description:
      "Professional installation of industrial equipment with precision and safety standards.",
  ...
  },
  {
    ...
    description:
      "Preventive and corrective maintenance to maximize equipment lifespan and performance.",
  ...
  },
  {
    ...
    description:
      "Custom steel fabrication and engineering solutions for industrial applications.",
  ...
  },
  {
    ...
    description:
      "24/7 commissioning and technical support for critical industrial operations.",
...
const whyChooseUs = [
  {
    ...
    description:
      "Over two decades of proven expertise in industrial machinery and engineering.",
    icon: Award,
  },
  {
    title: "Safety First",
  ...
  },
  {
    title: "Expert Team",
    description:
      "Skilled engineers and technicians with specialized industrial training.",
    icon: Users,
  },
  {
    title: "Quality Assured",
    description:
      "ISO-certified processes ensuring consistent, reliable results.",
    icon: Cog,
  },
];
  ...
  return (
    <Layout>
      ...
      <section className="relative min-h-[90vh] flex items-center overflow-hidden">
        ...
        {/* DARK OVERLAY */}
        <div className="absolute inset-0 bg-gradient-to-r from-industrial-dark/95 via-industrial-dark/85 to-industrial-dark/40 z-[1]" />
          ...
          <div className="max-w-[1400px] mx-auto">
            <div className="pl-6 md:pl-12 lg:pl-24 max-w-3xl animate-fade-in-up">
              ...
              <p className="text-lg md:text-xl text-secondary-foreground/80 mb-8 leading-relaxed">
                Arab Industrial Machinery FZC delivers comprehensive machinery
                installation, maintenance, and engineering services for factories
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="animate-slide-in-left">
              ...
              <p className="text-muted-foreground leading-relaxed mb-6">
                For over 10 years, Arab Industrial Machinery FZC has been the
                preferred partner for industrial facilities across the UAE and
                the wider Middle East region. We specialize in delivering turnkey
                machinery solutions that keep operations running efficiently and safely.
              </p>

              <p className="text-muted-foreground leading-relaxed mb-8">
                From initial consultation to installation and ongoing maintenance,
        ...
        <div className="container-custom">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <h2 className="industrial-subheading mb-6">
                Why Choose Us
              </h2>

              <p className="text-secondary-foreground/80 mb-12 text-lg">
                When you partner with Arab Industrial Machinery FZC, you get
                more than just a service provider. You get a committed team
