  ...
  const contactInfo = [
    {
      icon: MapPin,
      title: "Our Location",
      details: ["Industrial Area", "Office No: SF10236, 10th Floor, Tower 1, RAKEZ Service Centre, Amenity Centre - Al Jazeera Al Hamra Industrial - Ras Al Khaimah, UAE"]
    },
    {
      icon: Phone,
      title: "Phone",
      details: ["+97154 742 9429"]
    },
    {
      icon: Mail,
      title: "Email",
      details: ["contactaimuae@gmail.com"]
    },
    {
      icon: Clock,
      title: "Working Hours",
      details: ["Monday - Friday: 9:00 AM - 6:00 PM", "24/7 Emergency Support", "Saturday: 10:00 AM - 2:00 PM"]
    }
  ];
